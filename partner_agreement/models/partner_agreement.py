...
#General
     ...
     order_lines_services = fields.One2many(related='sale_order.order_line', string="Service Order Lines")
     order_lines_nonservices = fields.One2many(related='sale_order.order_line', string="Non Service Order Lines")
