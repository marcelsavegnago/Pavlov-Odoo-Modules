...
This module provides a project scrum to projects.
...
#. Have Manager rights for Project group to set projects to use scrum.
#. Go to project form then click the "Use Scrum".
#. When "Use Scrum" is enabled on a project, then the task form contains scrum related fields.
