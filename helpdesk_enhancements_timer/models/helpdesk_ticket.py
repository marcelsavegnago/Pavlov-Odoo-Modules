...
class HelpdeskTicket(models.Model):
    ...
    def ticket_end_timer(self):
        active_timer = self.env['timer.timer'].search([('ticket_id','=',self.id),('user_id','=',self._uid)])
        if not active_timer:
            stop_view_id = self.env.ref('project_enhancements_timer.timer_stop_warning_view_form')
