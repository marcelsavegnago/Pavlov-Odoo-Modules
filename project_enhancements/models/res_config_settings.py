...
class ResConfigSettings(models.TransientModel):
    ...
    module_project_enhancements_project_tags = fields.Boolean(string="Project Tags")
    module_project_enhancements_taskchecklist = fields.Boolean(string="Task Checklists")
